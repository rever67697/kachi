...
import com.aliyuncs.dycdpapi.transform.v20180610.QueryCdpOfferResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryCdpOfferResponse extends AcsResponse {
	...
	@Override
	public QueryCdpOfferResponse getInstance(UnmarshallerContext context) {
		return	QueryCdpOfferResponseUnmarshaller.unmarshall(this, context);
	}
}
